function [LBP_features_width, LBP_features_height] = LBP_TOP(pos, lf_num)
...
for k = 1:lf_num
    ...
    % call LBPTOP
    Histogram = LBPTOP(dis_lf, FxRadius, FyRadius, TInterval, NeighborPoints, TimeLength, BorderLength, bBilinearInterpolation, Bincount, Code);

    
    LBP_features_width(k,i,:) = Histogram(:);
    
    end
end

clearvars -except pos lf_num LBP_features_width
...
for k = 1:lf_num
    ...
    LBP_features_height(k,j,:) = Histogram(:);
    
    end
end

save LBP_features_width.mat LBP_features_width
save LBP_features_height.mat LBP_features_height